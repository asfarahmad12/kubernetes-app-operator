...
type KubernetesAppSpec struct {
	...
	// Foo is an example field of KubernetesApp. Edit kubernetesapp_types.go to remove/update
...
// KubernetesApp is the Schema for the kubernetesapps API
type KubernetesApp struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   KubernetesAppSpec   `json:"spec,omitempty"`
	Status KubernetesAppStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// KubernetesAppList contains a list of KubernetesApp
